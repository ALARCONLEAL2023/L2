...
fso.copyfolder "\\TNACAWFM193.tnsautoca.techint.net\APPLS\ClientLauncher", "D:\APPLS\Tenaris" ,true

Set WSHNetwork = CreateObject("WScript.Network")

strUser = CreateObject("WScript.Network").UserName

WSHNetwork.MapNetworkDrive "D:", "\\TNACAWFM193.tnsautoca.techint.net\APPLS\Logs\" + strUser
