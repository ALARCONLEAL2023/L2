...
fso.copyfolder "\\TNACAWFM194.tnsautoca.techint.net\Appls\ClientLauncher", "D:\Appls\Tenaris" ,true

Set WSHNetwork = CreateObject("WScript.Network")

strUser = CreateObject("WScript.Network").UserName

WSHNetwork.MapNetworkDrive "D:", "\\TNACAWFM194.tnsautoca.techint.net\Appls\Logs\" + strUser
